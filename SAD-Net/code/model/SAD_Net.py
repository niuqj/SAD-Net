...
class SADNet(nn.Module):
    def __init__(self, base_dim=32):
        ...
        self.down3 = nn.Sequential(nn.Conv2d(base_dim*2, base_dim*4, kernel_size=3, stride=2, padding=1),
                                   nn.ReLU(True))
        # level1
        self.down_level1_block1 = SDEBlock(default_conv, base_dim, 3)
        self.down_level1_block2 = SDEBlock(default_conv, base_dim, 3)
        self.down_level1_block3 = SDEBlock(default_conv, base_dim, 3)
        self.down_level1_block4 = SDEBlock(default_conv, base_dim, 3)
        self.up_level1_block1 = SDEBlock(default_conv, base_dim, 3)
        self.up_level1_block2 = SDEBlock(default_conv, base_dim, 3)
        self.up_level1_block3 = SDEBlock(default_conv, base_dim, 3)
        self.up_level1_block4 = SDEBlock(default_conv, base_dim, 3)
        # level2
        self.fe_level_2 = nn.Conv2d(in_channels=base_dim * 2, out_channels=base_dim * 2, kernel_size=3, stride=1, padding=1)
        self.down_level2_block1 = SDEBlock(default_conv, base_dim * 2, 3)
        self.down_level2_block2 = SDEBlock(default_conv, base_dim * 2, 3)
        self.down_level2_block3 = SDEBlock(default_conv, base_dim * 2, 3)
        self.down_level2_block4 = SDEBlock(default_conv, base_dim * 2, 3)
        self.up_level2_block1 = SDEBlock(default_conv, base_dim * 2, 3)
        self.up_level2_block2 = SDEBlock(default_conv, base_dim * 2, 3)
        self.up_level2_block3 = SDEBlock(default_conv, base_dim * 2, 3)
        self.up_level2_block4 = SDEBlock(default_conv, base_dim * 2, 3)
        # level3
        self.fe_level_3 = nn.Conv2d(in_channels=base_dim * 4, out_channels=base_dim * 4, kernel_size=3, stride=1, padding=1)
        self.level3_block1 = SDEABlock(default_conv, base_dim * 4, 3)
        self.level3_block2 = SDEABlock(default_conv, base_dim * 4, 3)
        self.level3_block3 = SDEABlock(default_conv, base_dim * 4, 3)
        self.level3_block4 = SDEABlock(default_conv, base_dim * 4, 3)
        self.level3_block5 = SDEABlock(default_conv, base_dim * 4, 3)
        self.level3_block6 = SDEABlock(default_conv, base_dim * 4, 3)
        self.level3_block7 = SDEABlock(default_conv, base_dim * 4, 3)
        self.level3_block8 = SDEABlock(default_conv, base_dim * 4, 3)
        # up-sample
