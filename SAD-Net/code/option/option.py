...
parser.add_argument('--dataset', type=str, default='Den')
...
parser.add_argument('--pre_trained_model', type=str, default='Den1', help='path of pre trained model for resume training')
