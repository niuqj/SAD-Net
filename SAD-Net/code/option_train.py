...
parser.add_argument('--iters_per_epoch', type=int,default=25)
parser.add_argument('--finer_eval_step', type=int,default=187500)
...
parser.add_argument('--seed', type=int, default=622, help='using warm up in learning rate')
parser.add_argument('--w_loss_L1', default=1., type=float, help='weight of loss L1')
parser.add_argument('--w_loss_CR', default=1, type=float, help='weight of loss CR')
parser.add_argument('--w_loss_wavelet', default=1, type=float, help='weight of loss wavelet')
